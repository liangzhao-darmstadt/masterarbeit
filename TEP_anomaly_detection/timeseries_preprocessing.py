# modified by LZ
# based on https://github.com/signals-dev/Orion/blob/master/orion/primitives/timeseries_preprocessing.py
...
def rolling_window_sequences(X, index, window_size, target_size, step_size, target_column, offset=0, drop=None,
                             drop_windows=False):
